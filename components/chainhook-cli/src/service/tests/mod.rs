...
#[test_case(json!({"scope":"print_event","contract_identifier": None::<String>,"contains": None::<String>}); "with scope print_event no fields")]
#[test_case(json!({"scope":"print_event","contract_identifier": "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.monkey-sip09","contains": None::<String>}); "with scope print_event just contract_identifier")]
#[test_case(json!({"scope":"print_event","contract_identifier": None::<String>,"contains": "vault"}); "with scope print_event just contains")]
