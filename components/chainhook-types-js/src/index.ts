...
export function checkBitcoinProof(
  txid: string,
  blockHash: string,
  merkleProof: string[],
  index: number
...
// Wire format:
// 1) 80 bytes: Block header (00000020662e181f6a5a6a32c617557b8b99665766fb6d30894b8c6dc95ae7a5541fec3094a49ed1f0c4f64d062e21786e9b31d2a0a4422488fe524f732f91e88ed0eff8f96c4d63ffff7f2001000000)
// 2) 4 bytes: Number of transaction in the block, little endian: (03000000)
// 3) Number of hashes (varint, 1 - 3 bytes): 02
// 4) Hashes (N * 32 bytes, little endian)
//         - 2e170a1c679957090bcec6fe4a528df8f6fe41ccb453f287607ddb82329991f0
//         - 381610a752745bf85071d66f1b3559f7168ea05495e983dc80e764e6b744006a
// 5) Number of bytes of flag bits (varint, 1 - 3 bytes) - 01
// 6) Flag bits (little endian) - 0d
