...
use crate::clarity::callables::DefinedFunction;
use crate::clarity::contexts::OwnedEnvironment;
use crate::clarity::costs::LimitedCostTracker;
use crate::clarity::database::MemoryBackingStore;
use crate::clarity::errors::{CheckErrors, Error, RuntimeErrorType, ShortReturnType};
use crate::clarity::tests::execute;
use crate::clarity::types::signatures::BufferLength;
use crate::clarity::types::{BuffData, QualifiedContractIdentifier, TypeSignature};
use crate::clarity::types::{PrincipalData, ResponseData, SequenceData, SequenceSubtype};
use crate::clarity::{eval, execute as vm_execute};
use crate::clarity::{CallStack, ContractContext, Environment, GlobalContext, LocalContext, Value};
...
fn test_simple_if_functions() {
    ...
    use crate::clarity::callables::DefineType::Private;
